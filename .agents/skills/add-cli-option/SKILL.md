---
name: add-cli-option
description: Add a new CLI option to the Remotion codebase. Use when converting a hardcoded flag into a proper AnyRemotionOption or adding a brand new one.
---
